...
public class GenerateSaleDocument : QuestPdf
{
    private readonly ServiceOrder _serviceOrder;

    public GenerateSaleDocument(ServiceOrder serviceOrder) : base(serviceOrder)
    {
        ...
        try
        {
            document.Page(page =>
            {
                ...
                page.Content().Column(column =>
                {
                    ...
                    column.Item().PaddingVertical(20).LineHorizontal(1).LineColor(Colors.Red.Darken2);
                });
            });
        }
        catch (Exception ex)
