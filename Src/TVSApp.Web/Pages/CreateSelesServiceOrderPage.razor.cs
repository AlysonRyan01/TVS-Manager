...
public partial class CreateSelesServiceOrderPage : ComponentBase
{
    public CreateCustomerCommand CreateCustomerCommand { get; set; } = new();
    public CreateSalesServiceOrderCommand CreateSalesServiceOrderCommand { get; set; } = new();
    ...
    public async Task CreateCustomer()
    {
        ...
        try
        {
            ...
            if (createResult.IsSuccess || createResult.Data != null)
            {
                ...
                CreateSalesServiceOrderCommand.CustomerId = createResult.Data!.Id;
    ...
    private async Task OpenConfirmCustomerDialog(long customerId)
    {
        ...
        if (!result!.Canceled)
        {
            ...
            if (SelectedCustomer != null)
            {
                ...
                CreateSalesServiceOrderCommand.CustomerId = SelectedCustomer.Id;
                _serviceOrderTime = true;
                _customerSideCompleted = true;
            }
            else
